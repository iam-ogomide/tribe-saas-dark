  ...
  return (
    <div className="bg-black text-white bg-gradient-to-b from-black to-[#5D2CA8] py-[72px] sm:py-24">
      <div className="container">
        ...
        <motion.div className="flex justify-center items-center"  style={{opacity: opacity, rotateX: rotateX, transformPerspective: "800px"}}>
          <Image src={appScreen} className="mt-14 " ref={appImage}/>
        </motion.div>
